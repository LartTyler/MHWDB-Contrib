...
export const attributeLabels = {
	...
	[AttributeName.GL_SHELLING_TYPE]: 'Shelling Type (Gunlance)',
	[AttributeName.HEALTH]: 'Health',
	[AttributeName.IG_BOOST_TYPE]: 'Boost Type (Insect Glaive)',
	[AttributeName.PHIAL_TYPE]: 'Phial Type (Charge Blade / Switch Axe)',
	...
	[AttributeName.SPECIAL_AMMO]: 'Special Ammo (Bowguns)',
