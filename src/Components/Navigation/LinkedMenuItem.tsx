...
interface LinkedMenuItemProps extends IMenuItemProps, RouteComponentProps<{}> {
	href: string;
}
 ...
 *
 * @param {LinkedMenuItemProps & {children?: React.ReactNode}} props
 * @returns {JSX.Element}
 * @constructor
 */
const LinkedMenuItemComponent: React.SFC<LinkedMenuItemProps> = props => {
